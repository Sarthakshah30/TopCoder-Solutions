...
public:
	string isDivisible(int A, int B, int C, int D) {
		...
		map<long long int, long long int> m1=findFactors(A,B);
		map<long long int, long long int> m2=findFactors(C,D);
	...
	map<long long int, long long int> findFactors(int ex,int power){
		
		map<long long int, long long int> m;
		
		for(int i = 2 ; i*i<=ex ; i++){
			if(ex%i==0){
