...
class PassingGrade {
public:
	int pointsNeeded(vector <int> got, vector <int> exp, int final) {
	...
	int needed = ceil(((total_marks+final)*65*1.0)/100);
	cout<<total_obtained<<" "<<total_marks<<" "<<needed<<endl;
	if(needed <= final + total_obtained)
	if(needed - total_obtained<0)
	return 0;
	else
